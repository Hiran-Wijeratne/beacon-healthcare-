...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative flex min-h-[calc(100dvh-104px)] flex-col items-center justify-center overflow-hidden pt-12 pb-20 text-center sm:min-h-[calc(100dvh-112px)] sm:pt-16 sm:pb-28"
    >
      <img
