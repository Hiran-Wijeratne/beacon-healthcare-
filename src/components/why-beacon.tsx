...
export default function WhyBeacon() {
  ...
  const riseStyle = (visible: boolean) => ({
    opacity: visible ? 1 : 0,
  ...
  return (
    <section id="why-beacon-content" className="px-6 py-20 sm:py-28">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div
          ref={features.ref}
          className="mt-16 grid gap-10 transition-all duration-500 ease-out sm:grid-cols-2 sm:gap-8 lg:grid-cols-4"
          style={riseStyle(features.visible)}
        >
        ...
        <div
          ref={stats.ref}
          className="mt-16 grid gap-y-8 transition-all duration-500 ease-out sm:grid-cols-2 sm:gap-8 lg:grid-cols-4"
          style={riseStyle(stats.visible)}
        >
          {trustStats.map((stat) => (
